...
class RiwayatPerubahan extends Page
{
    ...
    public const CHANGELOG = [
        [
            'date' => '25 Juni 2026',
            'changes' => [
                'Laporan: tabel baru "Perbandingan Bulanan per Toko" — tiap toko (baris) × 12 bulan (kolom) tampil SEKALIGUS agar mudah dibandingkan antar-bulan & antar-toko tanpa ganti-ganti bulan. Ada pemilih metrik (Laba / Omzet / Pesanan), kolom Total per toko, dan baris Total semua toko. Klik sel untuk membuka pesanan toko+bulan itu; angka diringkas (mis. "1,2 jt", "850 rb"). Totalnya konsisten dengan Laporan Bulanan.',
