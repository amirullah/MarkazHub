...
class RiwayatPerubahan extends Page
{
    ...
    public const CHANGELOG = [
        [
            'date' => '26 Juni 2026',
            'changes' => [
                'Penyempurnaan tombol salin No. Pesanan: ukuran tombol di toolbar diseragamkan (setinggi kotak Cari); dan tombol salin di menu Tindakan (untuk baris yang DICENTANG) diberi nama berbeda "Salin No. (terpilih)" agar tidak rancu dengan tombol toolbar yang menyalin SELURUH hasil filter.',
                ...
                'Tabel Pesanan: tombol "Salin No. Pesanan" kini tepat di SEBELAH KIRI kotak Cari — sekali klik mengambil SEMUA nomor pesanan sesuai filter aktif (tak perlu mencentang satu per satu), siap tempel ke Excel/teks (satu per baris). Berguna mis. mengumpulkan nomor pesanan yang butuh File Pesanan untuk diunduh ulang. (Untuk menyalin hanya baris tertentu: centang barisnya lalu pakai "Salin No. (terpilih)" di menu Tindakan.)',
