...
class RiwayatPerubahan extends Page
{
    ...
    public const CHANGELOG = [
        [
            'date' => '26 Juni 2026',
            'changes' => [
                'Impor pesanan lebih aman soal STATUS: saat upload ulang file marketplace, status pesanan kini DIPERBARUI dengan benar — perubahan MAJU (Perlu dikirim→Dikirim→Selesai) & TERMINAL (Dibatalkan/Dikembalikan) diterapkan; perubahan MUNDUR (mis. dari file lama yang diunggah belakangan) diabaikan; status terminal lama tak ditimpa. Pesanan yang berubah jadi Batal/Retur otomatis laba-nya disesuaikan (jadi 0). Hasil impor juga melaporkan berapa pesanan yang berubah status.',
                'Laporan (matriks Perbandingan Bulanan per Toko): tambah metrik "Biaya" — total biaya per bulan per toko (= Omzet − Laba; mencakup komisi/admin, ongkir, voucher, HPP/modal, dropship, biaya lain). Pilih tombol "Biaya" di pemilih metrik; bisa diurutkan & diklik per sel seperti metrik lain.',
